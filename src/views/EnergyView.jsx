  ...
  return (
    <div className="p-4 space-y-6 pb-24">
      ...
      {/* ============================================================
          ...
          ============================================================ */}
      <div className="bg-white/5 p-5 rounded-[2rem] border border-white/10 space-y-5 shadow-2xl">
        <h3 className="text-[10px] font-black font-mono text-orange-400 flex items-center gap-2 tracking-widest uppercase">
